...
Sprite order: chick, rooster, duck, cow, sheep, raccoon, hedgehog, bear, cat, wolf, turtle, lizard, frog, crab, fox

```javascript
export default [
  // Row 1: Chick, Rooster, Duck, Cow, Sheep
  { id: 'scrappy_chick', name: 'Scrappy Chick', price: 25, rarity: 'common',
    spriteIndex: 0,
    description: 'High Card becomes a weak single (1 chip, 1 mult) for ALL batters',
    effect: { type: 'team_convert_high_card', chips: 1, mult: 1 } },
  { id: 'morning_rooster', name: 'Morning Rooster', price: 35, rarity: 'uncommon',
    spriteIndex: 1,
    description: '+4 mult in innings 1-3',
    effect: { type: 'add_mult', value: 4, condition: { type: 'inning_range', min: 1, max: 3 } } },
  { id: 'lucky_duck', name: 'Lucky Duck', price: 40, rarity: 'rare',
    spriteIndex: 2,
    description: '15% chance a strikeout becomes a walk',
    effect: { type: 'strikeout_to_walk', chance: 0.15 } },
  { id: 'cash_cow', name: 'Cash Cow', price: 30, rarity: 'common',
    spriteIndex: 3,
    description: '+3 bonus chips after every at-bat',
    effect: { type: 'flat_chips_per_ab', value: 3 } },
  { id: 'black_sheep', name: 'Black Sheep', price: 45, rarity: 'rare',
    spriteIndex: 4,
    description: 'Pairs never degrade from Pitcher Adjusts',
    effect: { type: 'ignore_pair_penalty' } },
  // Row 2: Raccoon, Hedgehog, Bear, Cat, Wolf
  { id: 'trash_panda', name: 'Trash Panda', price: 35, rarity: 'uncommon',
    spriteIndex: 5,
    description: '20% chance to steal an extra card from deck on discard',
    effect: { type: 'bonus_draw_on_discard', chance: 0.20 } },
  { id: 'spike', name: 'Spike', price: 40, rarity: 'uncommon',
    spriteIndex: 6,
  ...
  { id: 'nine_lives', name: 'Nine Lives', price: 45, rarity: 'rare',
    spriteIndex: 8,
    description: 'First strikeout each inning becomes a foul ball (redraw hand)',
    effect: { type: 'strikeout_redraw', usesPerInning: 1 } },
  { id: 'lone_wolf', name: 'Lone Wolf', price: 35, rarity: 'uncommon',
    spriteIndex: 9,
  ...
  { id: 'iron_shell', name: 'Iron Shell', price: 30, rarity: 'common',
    spriteIndex: 10,
    description: 'Your pitcher: -8% hit chance',
    effect: { type: 'pitcher_hit_reduction', value: 0.08 } },
  { id: 'cold_blood', name: 'Cold Blood', price: 40, rarity: 'uncommon',
    spriteIndex: 11,
    description: '+3 mult for every run scored this inning',
    effect: { type: 'mult_per_inning_run', value: 3 } },
  { id: 'leap_frog', name: 'Leap Frog', price: 35, rarity: 'uncommon',
    spriteIndex: 12,
    description: 'All batters +10% extra base chance',
    effect: { type: 'team_extra_base', value: 0.10 } },
  { id: 'pinch_crab', name: 'Pinch Crab', price: 45, rarity: 'rare',
    spriteIndex: 13,
    description: 'Draw 9 cards instead of 8',
    effect: { type: 'add_hand_draw', value: 1 } },
  { id: 'sly_fox', name: 'Sly Fox', price: 50, rarity: 'rare',
    spriteIndex: 14,
